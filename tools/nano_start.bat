:: 启动redis服务器
start D:\Codes\GitLibrary\pm\tools\Redis-x64-3.2.100\redis-server.exe D:\Codes\GitLibrary\pm\tools\Redis-x64-3.2.100\redis.windows.conf
:: 启动consul注册中心，本地模式，将会使用127.0.0.1 的ip地址
start D:\Codes\GitLibrary\pm\tools\Consul\consul.exe agent -dev
:: 启动influxd数据库
start D:\Codes\GitLibrary\pm\tools\influxdb\influxdb-1.7.1-1\influxd.exe -config D:\Codes\GitLibrary\pm\tools\influxdb\influxdb-1.7.1-1\influxdb.conf
:: 启动IdentityServer服务器
